...
public class SoulissBindingConstants {
    ...
    static {
        SUPPORTED_THING_TYPES_UIDS.add(GATEWAY_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T11_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T12_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T13_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T14_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T16_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T18_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T19_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T1A_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T21_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T22_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T31_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T41_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T42_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T51_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T52_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T53_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T54_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T55_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T56_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T57_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T58_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T61_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T62_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T63_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T64_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T65_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T66_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T67_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(T68_THING_TYPE);
        SUPPORTED_THING_TYPES_UIDS.add(TOPICS_THING_TYPE);
    }
